...
<div class="card">
                ...
                <?php $__currentLoopData = $user->rating; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($rat->fuser_id == Auth::user()->id  ): ?>
                        <?php $a=0;?>
                        <?php break; ?>
                        <?php else: ?> 
                        <?php $a=$a+1;?>
            ...
            <h3>Notes&&</h3>
             <div class="Comment" id="comment-box">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if(count($user->note)>0): ?>
                  <?php $b=0; ?>
                <?php $__currentLoopData = $user->note; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        
                        <?php if($no->fuser_id == Auth::user()->id  ): ?>
                        <?php $b=0;?>
                        <?php break; ?>
                        <?php else: ?> 
                        <?php $b=$b+1;?>
