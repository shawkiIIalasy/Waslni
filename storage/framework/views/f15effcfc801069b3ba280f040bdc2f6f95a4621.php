...
<!-- side nav css file -->
<link href='/admin/SidebarNav.min.css' media='all' rel='stylesheet' type='text/css'/>
<!-- //side nav css file -->
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					<link href="/admin/owl.carousel.css" rel="stylesheet">
	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="#"><span ><img src="/images/sublogo.png" width="40px" height="30px;"></span> Waslni<span class="dashboard_text">Admin dashboard</span></a></h1>
          </div>
            ...
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                  <li><a href="/driver"><i class="fa fa-angle-right"></i>Driver</a></li>
                  <li><a href="/passnger"><i class="fa fa-angle-right"></i>Passnger</a></li>
                  <li><a href="/admin"><i class="fa fa-angle-right"></i>admin</a></li>
                </ul>
              </li>
              <li class="treeview">
                <a href="#">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img">
										...
										<img src="/images/team2.jpg" alt="" width="50px;" height="50px;"> </span> 
										<?php else: ?>
										<img src="/storage/cover_image/<?php echo e($trip->user->cover_image); ?>" alt="" width="50px;" height="50px;"> </span> 
										<?php endif; ?>
									<div class="user-name">
										<p style="color:#000;"><?php echo e(auth()->user()->name); ?></p>
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong><?php echo e(count($users)); ?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-cab user1 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo e(count($cars)-1); ?></strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-male user2 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo e(count($users)-(count($cars)-1)); ?></strong></h5>
                      <span>Total Passnger</span>
                    </div>
                </div>
        	</div>
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-plane dollar1 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo e(count($trips)); ?></strong></h5>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    <i class="pull-left fa fa-tag dollar2 icon-rounded"></i>
                    <div class="stats">
                      <h5><strong><?php echo e(count($reservate)); ?></strong></h5>
                      <span>Total Reservates</span>
                    </div>
                </div>
        	 </div>
        	<div class="clearfix"> </div>
