...
<div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><h4>UpComing Trips</h4></div>
      ...
      <?php $__currentLoopData = $trip->reservate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(date("Y-m-d") <= $trip->date ): ?>
          ...
          <?php else: ?>
                ...
                <div class="panel-body">
                    <img src="<?php echo e(asset('images/no.png')); ?>" height="150px" width="150px" style="float: left;"><h1 style="margin-top: 60px">No Have Coming Trips Yet</h1> 
                </div>
                <?php break 2?>
