...
<link href="//netdna.bootstrapcdn.com/bootstrap/3.0.0/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
 ...
 <link rel="shortcut icon"  href="<?php echo e(asset('images/sublogo.png')); ?>" >
    <!-- Scripts -->
    <script>
...
<?php echo e(date("H:i:s")); ?>&nbsp;&nbsp;<?php echo e(date("Y/m/d")); ?>
                       ...
                       <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" >
                        ...
                        <ul class="dropdown-menu notify-drop" style="width:300px;float: right" role="menu"> <div class="drop-content">
                          ...
                          <?php if($note->type=='App\Notifications\NotifyTripReservate'): ?>
                            ...
                            <hr>
                            <a href="/trips/<?php echo e($note->data['user_id']); ?>" class="btn btn-primary">All</a>
                            </div>
                            <?php $note->markAsRead(); ?>
                            </a></li>
                            <?php else: ?> 
