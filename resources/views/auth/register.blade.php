...
<html lang="{{ config('app.locale') }}">
        ...
        <div class="gtco-container">
            ...
            <div class="row">
                <div class="col-sm-4 col-xs-12">
                    <div id="gtco-logo"><a href="/"><img src="{{asset('images/logo.png')}}" style="width:200px;height: 100px;margin-top: 30px;"></div>
                </div>
           ...
           <li class="btn-cta"> @if (Route::has('login'))
          
                    @if (Auth::check())
                         <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" >
                                   <img src="/storage/cover_image/{{Auth::user()->cover_image}}" class="img-circle" alt="Cinque Terre" width="30px" height="30px"> {{ Auth::user()->name }} <span class="caret"></span>
                                </a>
    ...
    <header id="gtco-header" class="gtco-cover" role="banner" style="background-image: url(images/img_4.jpg);height: 900px ">
                                            ...
                                            <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                                                ...
                                                <div class="row form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" maxlength="12" required autofocus>
