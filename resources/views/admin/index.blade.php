							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img">
										...
										@else
										<img src="/storage/cover_image/{{$trip->user->cover_image}}" alt="" width="50px;" height="50px;"> </span> 
										@endif
									<div class="user-name">
		...
		<div id="page-wrapper">
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{count($users)}}</strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{count($cars)-1}}</strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{count($users)-(count($cars)-1)}}</strong></h5>
        	...
        	<div class="col-md-3 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{count($trips)}}</strong></h5>
        	...
        	<div class="col-md-3 widget">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{count($reservate)}}</strong></h5>
